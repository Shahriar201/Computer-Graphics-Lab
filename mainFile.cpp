...
void drawScene() {
    ...
    glColor3f (0.0, .75, .35);
    glBegin(GL_POLYGON);
    glVertex3f (0.1, 0.1, 0.18);
    glVertex3f (0.2, 0.1, 0.18);
    glVertex3f (0.2, 1.0, 0.18);
    glVertex3f (0.1, 1.0, 0.18);
    glEnd();

    //column 2
    glColor3f (0.0, .75, .35);
    glBegin(GL_POLYGON);
    glVertex3f (0.1, 0.1, 0.30);
    glVertex3f (0.2, 0.1, 0.30);
    glVertex3f (0.2, 1.0, 0.30);
    glVertex3f (0.1, 1.0, 0.30);
    glEnd();
    ...
    //column Triangle front
    glColor3f (0.0, 1.0, 0.35);
    glBegin(GL_TRIANGLES);
    glVertex3f (0.09, 1.0, 0.18);
    glVertex3f (0.21, 1.0, 0.18);
    glVertex3f (0.15, 1.1, 0.24);
    glEnd();

    //column Triangle back
    glColor3f (0.0, 1.0, 0.35);
    glBegin(GL_TRIANGLES);
    glVertex3f (0.21, 1.0, 0.30);
    glVertex3f (0.09, 1.0, 0.30);
    glVertex3f (0.15, 1.1, 0.24);
    glEnd();

    //column Triangle left
    glColor3f (0.0, 1.8, 0.35);
    glBegin(GL_TRIANGLES);
    glVertex3f (0.09, 1.0, 0.30);
    glVertex3f (0.09, 1.0, 0.18);
    glVertex3f (0.15, 1.1, 0.24);
